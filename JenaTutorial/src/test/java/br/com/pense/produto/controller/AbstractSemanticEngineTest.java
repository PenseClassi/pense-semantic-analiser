...
//        
//        System.out.println("----------------------------------------------------------------------------");
//        engImoveis.preparaConteudoBusca("cobertura com 2 a 3 dormitorios, 2 a 3 suites, 1 banheiro com garagem piscina churrasqueira");
//        engImoveis.executeQuery();
...
//        engImoveis.executeQuery();
//        assertEquals("{Banheiros=[1:5], Infraestrutura=[Piscina], Características=[Churrasqueira], Dormitórios=[1:5], Suítes=[1:5], Vagas de garagem=[1:], Tipo de imóvel=[Cobertura]}", engImoveis.getResultsAsString());
//        
//        
//    }
    ...
    public void testValores(){
        ...
        System.out.println("----------------------------------------------------------------------------");
        assertEquals("cobertura apartir de R$ 3.000,00", engImoveis.executaPreProcessamento("cobertura apartir de R$ 3mil"));
        engImoveis.preparaConteudoBusca("cobertura apartir de R$ 3.000,00");
        engImoveis.executeQuery();
        engImoveis.getResultsAsString();
        
        System.out.println("----------------------------------------------------------------------------");
        assertEquals("cobertura apartir de R$ 3.000,00", engImoveis.executaPreProcessamento("cobertura apartir de R$ 3 mil"));
        System.out.println("----------------------------------------------------------------------------");
        assertEquals("cobertura apartir de R$ 3.000,00 com piscina", engImoveis.executaPreProcessamento("cobertura apartir de R$ 3mil com piscina"));
        System.out.println("----------------------------------------------------------------------------");
        assertEquals("cobertura apartir de R$ 3.000,00 com piscina", engImoveis.executaPreProcessamento("cobertura apartir de R$ 3 mil com piscina"));
        System.out.println("----------------------------------------------------------------------------");
        assertEquals("cobertura entre 3.000.000,00 e 4.000.000,00, com sacada", engImoveis.executaPreProcessamento("cobertura entre 3 milhões e 4 milhões, com sacada"));
        System.out.println("----------------------------------------------------------------------------");
        assertEquals("cobertura entre 3.000.000,00 e 4.000.000,00, com sacada", engImoveis.executaPreProcessamento("cobertura entre 3 milhões e 4 milhões com sacada"));
        System.out.println("----------------------------------------------------------------------------");
        assertEquals("cobertura apartir de R$ 3.000,00 entre 3.000.000,00 e 4.000.000,00 com sacada", engImoveis.executaPreProcessamento("cobertura apartir de R$ 3 mil entre 3 milhões e 4 milhões com sacada"));
        System.out.println("----------------------------------------------------------------------------");
        assertEquals("apartamento com 2.000 m2", engImoveis.executaPreProcessamento("apartamento com 2mil metros quadrados"));
        System.out.println("----------------------------------------------------------------------------");
        assertEquals("apartamento com 2.000 m2 apartir de R$ 3.000,00", engImoveis.executaPreProcessamento("apartamento com 2mil metros quadrados apartir de R$ 3 mil"));
    }
